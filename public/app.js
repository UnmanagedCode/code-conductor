...
const dom = {
  ...
  apdSystem: document.getElementById('apd-system'),
  apdSystemNote: document.getElementById('apd-system-note'),
  apdRemote: document.getElementById('apd-remote'),
  apdRemoteRow: document.getElementById('apd-remote-row'),
...
installAdoptProjectDialog({
  dom: {
    ...
    apdName: dom.apdName,
    apdSystem: dom.apdSystem,
    apdSystemNote: dom.apdSystemNote,
    apdRemote: dom.apdRemote,
    apdRemoteRow: dom.apdRemoteRow,
    apdPath: dom.apdPath,
