...
const dom = {
  ...
  npSetupPrompts: document.getElementById('np-setup-prompts'),
  npSetupPromptsList: document.getElementById('np-setup-prompts-list'),
...
installNewProjectDialog({
  dom: {
    ...
    npSetupPrompts: dom.npSetupPrompts,
    npSetupPromptsList: dom.npSetupPromptsList,
  },
  refreshProjects,
  closeSidebarOverflow,
});
