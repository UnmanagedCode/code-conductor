...
- **Follow the tool's summary template.** Completed-work entries are conclusions + pointers (merge sha, worker sessionId, worktree) — a follow-up about landed work is answered from transcripts/diffs.
