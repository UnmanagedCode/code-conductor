...
│   ├── settings.json                        # app settings, e.g. {transcribe:{model}, models:{sonnet,opus,haiku}}
│   └── projects/<project>/
