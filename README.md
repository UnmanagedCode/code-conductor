...
|---|---|---|
| `GET` | `/api/projects` | `[{name, path, group, instanceIds[], isGitRepo, sessions, worktrees}]`. `group` is the trimmed string from the project's `.claude-orch-app/project.json` or `null` when unset. |
