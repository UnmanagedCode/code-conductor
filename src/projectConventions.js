...
// Plugin-contributed guideline fragments join the catalog through this
...
let pluginGuidelinesProvider = async () => [];
export function setPluginGuidelinesProvider(fn) { pluginGuidelinesProvider = fn ?? (async () => []); }
...
const catalog = createFragmentCatalog({
  ...
  noun: 'convention',
  extraProvider: () => pluginGuidelinesProvider(),
});
