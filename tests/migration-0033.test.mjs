...
import { run, name } from '../migrations/0033-retire-session-roots.mjs';

describe('migration 0033: retire the session roots', () => {
  let root;
  ...
  test('the module names itself for the log line', () => {
    assert.equal(name, '0033-retire-session-roots');
  });
});
