...
export const FIXTURE_LOCAL_ROOTS = [
  ...
  { prefix: '/home/node/.claude/plans', access: 'allow', why: 'plan mode writes its plan file here' },
  { prefix: '/home/node/.claude', access: 'deny', why: "the CLI's own settings and credentials" },
  { prefix: '/home/node/.claude/projects', access: 'deny', why: "every session on this machine's transcripts" },
];
