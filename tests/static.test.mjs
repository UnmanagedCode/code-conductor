...
test('serves each public asset', async () => {
  ...
  try {
    for (const asset of ['/app.js', '/ws.js', '/sidebar.js', '/conversation.js', '/blocks.js', '/composer.js', '/styles.css', '/sw.js', '/notifications.js', '/diff.js',
      '/appSwitcher.js', '/pluginView.js', '/pluginBridge.js', '/pluginManager.js', '/unread.js', '/accountUsage.js', '/sidebarChrome.js']) {
...
test('spawn dialog hosts a Code / Plan & Approve segmented toggle, default Code', async () => {
  ...
  assert.equal(plan.getAttribute('aria-pressed'), 'false', 'Plan & Approve starts unpressed');
...
test('DOM-free public modules import cleanly in Node', async () => {
  ...
  for (const asset of ['blocks.js', 'sidebar.js', 'conversation.js', 'composer.js', 'unread.js', 'accountUsage.js', 'sidebarChrome.js']) {
