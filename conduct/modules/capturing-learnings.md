...
**Where it goes:**
- **Private orchestration lessons** (model-tier fit, a worker quirk, a pacing trick) → your private knowledge store (whichever knowledge module or plugin is enabled). No sign-off needed — it binds nobody but you.
