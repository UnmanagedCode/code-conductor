...
- **A remote worker's FUSE-union chroot — the tier table, the mount record, teardown, the boot sweep, `CC_FUSE_WORKERS`** → `src/systems/fuse/`; `docs/architecture.md` → "The FUSE-union chroot" and "FUSE teardown"
