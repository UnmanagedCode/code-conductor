// Migration 0012: drop the retired `execution-modes` conductor-module slug
// from a persisted `enabled` selection.
//
// The `execution-modes` module was folded into `canonical-workflow` and
// removed from SEED_MODULES (src/conductModules.js). A stored `enabled`
...
// 'execution-modes'" (400), since compose() resolves slugs against the
...
// Idempotent: a no-op once `execution-modes` is absent from `enabled`.
//
...
export const name = '0012-drop-retired-execution-modes-slug';
...
const RETIRED_SLUG = 'execution-modes';
